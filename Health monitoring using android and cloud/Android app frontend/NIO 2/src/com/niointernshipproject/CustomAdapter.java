...
public class CustomAdapter extends BaseAdapter{
 ...
 List<String> imageId;
    ...
    public CustomAdapter(User_selection user_selection, List<String> users, List<String> user_idArray) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;       
             ...
             holder.tv=(TextView) rowView.findViewById(R.id.list_heading);

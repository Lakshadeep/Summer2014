...
public class User_selection_edit extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setAdapter(new Custom_user_selection_edit(this, users,user_idArray,user_name));
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
		      ...
		      public void onItemClick(AdapterView<?> v, View arg1, int position, long arg3) {
		    	  String userid = user_idArray.get(position);
	        		...
	        		Intent a = new Intent(v.getContext(),Edit_form_selection_class.class);
	        		a.putExtras(basket);
	        		startActivity(a); 

...
public class Custom_user_selection_edit extends BaseAdapter{
    List<String> result,name;
    Context context;
 List<String> imageId;
      private static LayoutInflater inflater=null;
    public Custom_user_selection_edit(User_selection_edit user_selection, List<String> users, List<String> user_idArray,List<String> user_name) {

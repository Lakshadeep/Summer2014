...
public class Receive extends Activity implements OnClickListener,LocationListener{
TextView tvReceived_data,tv_connection_msg,tv_location;
...
Button open_bt,send_bt,close_bt;
EditText send_data;
...
double lat,lng;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		send_bt = (Button)findViewById(R.id.send_data);
		send_bt.setOnClickListener(this);
		send_bt.setBackgroundColor(Color.BLACK);
...
void openBT() throws IOException
{
   ...
   tv_connection_msg.setTextColor(Color.GREEN);
    Toast.makeText(Receive.this, "Device connection opened!", Toast.LENGTH_LONG).show();
}
...
public void onClick(View v) {
	...
	case R.id.send_data:
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			tv_connection_msg.setText("Error: data transfer was unsuccessful");
			tv_connection_msg.setTextColor(Color.RED);
